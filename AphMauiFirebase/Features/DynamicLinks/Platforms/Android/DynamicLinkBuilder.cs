...
using APH.Maui.Firebase.DynamicLinks.Parameters;
using APH.Maui.Firebase.DynamicLinks.Platforms.Android.Extensions;
using Firebase.DynamicLinks;
using AndroidUri = Android.Net.Uri;

namespace APH.Maui.Firebase.DynamicLinks.Platforms.Android;
...
public sealed class DynamicLinkBuilder : IDynamicLinkBuilder
{
    ...
    public async Task<ShortDynamicLink> BuildShortDynamicLinkAsync()
    {
        ...
        var result = _builder.SetLongLink(link.Uri).BuildShortDynamicLink();
