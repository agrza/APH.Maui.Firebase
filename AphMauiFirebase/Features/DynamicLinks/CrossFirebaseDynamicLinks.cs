...
{
    private static Lazy<IFirebaseDynamicLinks> _implementation = new Lazy<IFirebaseDynamicLinks>(CreateInstance, System.Threading.LazyThreadSafetyMode.PublicationOnly);
...
#pragma warning restore IDE0022 // Use expression body for methods
    ...
    public static void Dispose()
    {
        if (_implementation != null && _implementation.IsValueCreated)
        {
            ...
            _implementation = new Lazy<IFirebaseDynamicLinks>(CreateInstance, System.Threading.LazyThreadSafetyMode.PublicationOnly);
        }
    }
}